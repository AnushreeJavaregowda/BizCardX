...
icon = Image.open(r"C:\Users\HP\Downloads\3.png")
st.set_page_config(page_title="BizCardX: Extracting Business Card Data with OCR | By ` ANUSHREE J`",
                   page_icon=icon,
                   layout="wide",
                   initial_sidebar_state="expanded",
                   menu_items={'About': """# This OCR app is created by `ANUSHREE J!`"""})
